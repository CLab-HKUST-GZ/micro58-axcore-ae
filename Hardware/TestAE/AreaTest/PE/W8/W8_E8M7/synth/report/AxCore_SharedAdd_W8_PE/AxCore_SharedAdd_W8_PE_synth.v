...
module SNC_W8 ( Wq_FP_In, Wq_FmtSel, StochasticBit, Wq_NotZero, Wq_FP_Out );
  ...
  OAI32D0BWP30P140 U3 ( .A1(n3), .A2(n5), .A3(n2), .B1(n6), .B2(n1), .ZN(
        Wq_FP_Out[1]) );
  INVD0BWP30P140 U4 ( .I(Wq_FP_In[2]), .ZN(n5) );
  NR4D0BWP30P140 U5 ( .A1(\Wq_FP_In[6] ), .A2(\Wq_FP_In[5] ), .A3(
        \Wq_FP_In[4] ), .A4(\Wq_FP_In[3] ), .ZN(n6) );
  INVD0BWP30P140 U6 ( .I(Wq_FP_In[0]), .ZN(n2) );
  NR2D1BWP30P140 U7 ( .A1(n6), .A2(n2), .ZN(Wq_FP_Out[0]) );
  INVD0BWP30P140 U8 ( .I(Wq_FP_In[1]), .ZN(n1) );
...
module AdderInt ( X, Y, Sum );
  ...
  input [15:0] Y;
  output [15:0] Sum;
  wire   \Y[3] , \Y[2] , \Y[1] , \Y[0] , \intadd_0/CI , \intadd_0/n6 ,
         \intadd_0/n5 , \intadd_0/n4 , \intadd_0/n3 , \intadd_0/n2 ,
         \intadd_0/n1 , n9, n10, n11, n12, n13;
  assign Sum[3] = \Y[3] ;
  assign \Y[3]  = Y[3];
  assign Sum[2] = \Y[2] ;
  assign \Y[2]  = Y[2];
  ...
  FA1D0BWP30P140 \intadd_0/U7  ( .A(X[5]), .B(Y[5]), .CI(\intadd_0/CI ), .CO(
        \intadd_0/n6 ), .S(Sum[5]) );
  FA1D0BWP30P140 \intadd_0/U6  ( .A(X[6]), .B(Y[6]), .CI(\intadd_0/n6 ), .CO(
        \intadd_0/n5 ), .S(Sum[6]) );
  FA1D0BWP30P140 \intadd_0/U5  ( .A(X[7]), .B(Y[7]), .CI(\intadd_0/n5 ), .CO(
        \intadd_0/n4 ), .S(Sum[7]) );
  FA1D1BWP30P140 \intadd_0/U4  ( .A(X[8]), .B(Y[8]), .CI(\intadd_0/n4 ), .CO(
        \intadd_0/n3 ), .S(Sum[8]) );
  FA1D1BWP30P140 \intadd_0/U3  ( .A(X[9]), .B(Y[9]), .CI(\intadd_0/n3 ), .CO(
        \intadd_0/n2 ), .S(Sum[9]) );
  FA1D1BWP30P140 \intadd_0/U2  ( .A(X[10]), .B(Y[10]), .CI(\intadd_0/n2 ), 
        .CO(\intadd_0/n1 ), .S(Sum[10]) );
  XNR3UD0BWP30P140 U1 ( .A1(X[15]), .A2(Y[15]), .A3(n13), .ZN(Sum[15]) );
  AN2D0BWP30P140 U2 ( .A1(Y[4]), .A2(X[4]), .Z(\intadd_0/CI ) );
  IAO21D1BWP30P140 U3 ( .A1(Y[4]), .A2(X[4]), .B(\intadd_0/CI ), .ZN(Sum[4])
         );
  AN2D0BWP30P140 U4 ( .A1(\intadd_0/n1 ), .A2(Y[11]), .Z(n9) );
  IAO21D1BWP30P140 U5 ( .A1(\intadd_0/n1 ), .A2(Y[11]), .B(n9), .ZN(Sum[11])
         );
  ND3D1BWP30P140 U6 ( .A1(\intadd_0/n1 ), .A2(Y[11]), .A3(Y[12]), .ZN(n11) );
  OA21D0BWP30P140 U7 ( .A1(n9), .A2(Y[12]), .B(n11), .Z(Sum[12]) );
  INVD0BWP30P140 U8 ( .I(Y[13]), .ZN(n10) );
  NR2D1BWP30P140 U9 ( .A1(n10), .A2(n11), .ZN(n12) );
  AOI21D1BWP30P140 U10 ( .A1(n11), .A2(n10), .B(n12), .ZN(Sum[13]) );
  ND2D1BWP30P140 U11 ( .A1(n12), .A2(Y[14]), .ZN(n13) );
  OA21D0BWP30P140 U12 ( .A1(n12), .A2(Y[14]), .B(n13), .Z(Sum[14]) );
endmodule
...
module GuardAW ( AW_In, Wq_NotZero, A_Valid, AW_Out );
  ...
  INR2D1BWP30P140 U3 ( .A1(AW_In[3]), .B1(n1), .ZN(AW_Out[3]) );
  INR2D1BWP30P140 U4 ( .A1(AW_In[2]), .B1(n1), .ZN(AW_Out[2]) );
  INR2D1BWP30P140 U5 ( .A1(AW_In[0]), .B1(n1), .ZN(AW_Out[0]) );
  INR2D1BWP30P140 U6 ( .A1(AW_In[1]), .B1(n1), .ZN(AW_Out[1]) );
  INR2D1BWP30P140 U7 ( .A1(AW_In[4]), .B1(n1), .ZN(AW_Out[4]) );
  INR2D1BWP30P140 U8 ( .A1(AW_In[5]), .B1(n1), .ZN(AW_Out[5]) );
  INR2D1BWP30P140 U9 ( .A1(AW_In[6]), .B1(n1), .ZN(AW_Out[6]) );
...
module AxCore_SharedAdd_W8_PE ( Wq_CIN_FP, Wq_COUT_FP, T_CIN_TC, T_COUT_TC, 
  ...
  output A_Vld_COUT;
  wire   A_Vld_CIN, SNC_Wq8_Wq_NotZero, n1, n2, n3, n4, n5, n6, n7, n8, net306,
         net307, net308, net309, net310, net311, net312, net313, net314,
         net315;
  ...
  SNC_W8 SNC_Wq8 ( .Wq_FP_In(Wq_COUT_FP), .Wq_FmtSel({net314, net315}), 
        .StochasticBit(T_CIN_TC[6]), .Wq_NotZero(SNC_Wq8_Wq_NotZero), 
        .Wq_FP_Out(SNC_Wq8_Wq_FP_Out) );
  AdderInt AxMultS1 ( .X({SNC_Wq8_Wq_FP_Out[7], net306, net307, net308, net309, 
        SNC_Wq8_Wq_FP_Out[6:0], net310, net311, net312, net313}), .Y(T_CIN_TC), 
        .Sum(AxMultS1_Sum) );
