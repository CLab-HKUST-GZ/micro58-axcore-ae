...
module AdderInt ( X, Y, Sum );
  ...
  input [15:0] Y;
  output [15:0] Sum;
  wire   \Y[4] , \Y[3] , \Y[2] , \Y[1] , \Y[0] , \intadd_0/CI , \intadd_0/n4 ,
         \intadd_0/n3 , \intadd_0/n2 , \intadd_0/n1 , n11, n12, n13, n14, n15,
         n16, n17;
  assign Sum[4] = \Y[4] ;
  assign \Y[4]  = Y[4];
  assign Sum[3] = \Y[3] ;
  ...
  FA1D0BWP30P140 \intadd_0/U5  ( .A(X[6]), .B(Y[6]), .CI(\intadd_0/CI ), .CO(
        \intadd_0/n4 ), .S(Sum[6]) );
  FA1D0BWP30P140 \intadd_0/U4  ( .A(X[7]), .B(Y[7]), .CI(\intadd_0/n4 ), .CO(
        \intadd_0/n3 ), .S(Sum[7]) );
  FA1D0BWP30P140 \intadd_0/U3  ( .A(X[8]), .B(Y[8]), .CI(\intadd_0/n3 ), .CO(
        \intadd_0/n2 ), .S(Sum[8]) );
  FA1D0BWP30P140 \intadd_0/U2  ( .A(X[9]), .B(Y[9]), .CI(\intadd_0/n2 ), .CO(
        \intadd_0/n1 ), .S(Sum[9]) );
  AN2D0BWP30P140 U1 ( .A1(Y[5]), .A2(X[5]), .Z(\intadd_0/CI ) );
  IAO21D1BWP30P140 U2 ( .A1(Y[5]), .A2(X[5]), .B(\intadd_0/CI ), .ZN(Sum[5])
         );
  ND2D1BWP30P140 U3 ( .A1(\intadd_0/n1 ), .A2(Y[10]), .ZN(n12) );
  OA21D0BWP30P140 U4 ( .A1(\intadd_0/n1 ), .A2(Y[10]), .B(n12), .Z(Sum[10]) );
  INVD0BWP30P140 U5 ( .I(Y[11]), .ZN(n11) );
  NR2D1BWP30P140 U6 ( .A1(n11), .A2(n12), .ZN(n13) );
  AOI21D1BWP30P140 U7 ( .A1(n12), .A2(n11), .B(n13), .ZN(Sum[11]) );
  ND2D1BWP30P140 U8 ( .A1(n13), .A2(Y[12]), .ZN(n15) );
  OA21D0BWP30P140 U9 ( .A1(n13), .A2(Y[12]), .B(n15), .Z(Sum[12]) );
  INVD0BWP30P140 U10 ( .I(Y[13]), .ZN(n14) );
  NR2D1BWP30P140 U11 ( .A1(n14), .A2(n15), .ZN(n16) );
  AOI21D1BWP30P140 U12 ( .A1(n15), .A2(n14), .B(n16), .ZN(Sum[13]) );
  ND2D1BWP30P140 U13 ( .A1(n16), .A2(Y[14]), .ZN(n17) );
  OA21D0BWP30P140 U14 ( .A1(n16), .A2(Y[14]), .B(n17), .Z(Sum[14]) );
  XNR3UD0BWP30P140 U15 ( .A1(X[15]), .A2(Y[15]), .A3(n17), .ZN(Sum[15]) );
endmodule
...
module GuardAW ( AW_In, Wq_NotZero, A_Valid, AW_Out );
  ...
  INR2D1BWP30P140 U4 ( .A1(AW_In[1]), .B1(n1), .ZN(AW_Out[1]) );
  INR2D1BWP30P140 U5 ( .A1(AW_In[2]), .B1(n1), .ZN(AW_Out[2]) );
  INR2D1BWP30P140 U6 ( .A1(AW_In[3]), .B1(n1), .ZN(AW_Out[3]) );
...
module AxCore_SharedAdd_MPWq4_PE ( Wq_CIN_FP, Wq_COUT_FP, Wq_FmtSel, T_CIN_TC, 
  ...
  output A_Vld_COUT;
  wire   A_Vld_CIN, SNC_MPWq4_Wq_NotZero, n1, n2, n3, n4, net381, net382,
         net383, net384, net385, net386, net387, net388, net389, net390;
  ...
  SNC_W4 SNC_MPWq4 ( .Wq_FP_In(Wq_COUT_FP), .Wq_FmtSel(Wq_FmtSel), 
        .StochasticBit(T_CIN_TC[6]), .Wq_NotZero(SNC_MPWq4_Wq_NotZero), 
        .Wq_FP_Out(SNC_MPWq4_Wq_FP_Out) );
  AdderInt AxMultS1 ( .X({SNC_MPWq4_Wq_FP_Out[5], net381, net382, net383, 
        net384, net385, SNC_MPWq4_Wq_FP_Out[4:0], net386, net387, net388, 
        net389, net390}), .Y(T_CIN_TC), .Sum(AxMultS1_Sum) );
